...
export default function Details() {
    ...
    const message   = `Olá ${incident.nome} estou entrando em contato pois gostaria de ajudar no caso "${incident.title}" com o valor de ${incident.value} reais`;
